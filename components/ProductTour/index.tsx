...
export function ProductTour() {
  return (
    <section id="product" className="relative border-t border-stroke">
      ...
      <div className="shell py-24 text-left md:text-center lg:py-32">
        <h2 className="mx-auto max-w-4xl text-balance text-3xl font-light leading-[1.1] tracking-[-0.025em] text-ink sm:text-4xl lg:text-[56px]">
