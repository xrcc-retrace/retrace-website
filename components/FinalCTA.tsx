  ...
  return (
    <section id="final-cta" className="border-t border-stroke">
      <div className="shell py-16 lg:py-20">
        ...
        >
          <div className="relative z-10 flex flex-col items-center px-8 py-12 text-center lg:px-14 lg:py-16">
            <blockquote className="text-balance text-2xl font-medium leading-[1.18] tracking-[-0.012em] text-ink lg:text-5xl">
